              ...
              <div className="card-body">
                <div className="row">
                  <Lightbox
                    ...
                    slides={[
                      { src: "/nextjs/template/src/assets/img/media/img-01.jpg" },
                      { src: "/nextjs/template/src/assets/img/media/img-02.jpg" },
                    ]}
                  />
                ...
                <div className="card-body">
                  <div className="row">
                    <Lightbox
                      ...
                      slides={[
                        { src: "/nextjs/template/src/assets/img/media/img-03.jpg" },
                        { src: "/nextjs/template/src/assets/img/media/img-04.jpg" },
                        { src: "/nextjs/template/src/assets/img/media/img-05.jpg" },
                      ]}
                    />
                    <div className="col-md-4 mb-2 mb-md-0">
                      <Link
